  ...
  return (
    <section className="grid md:grid-cols-2 min-h-[600px]">
      <div className="relative overflow-hidden min-h-[500px] group">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-transparent to-[#f5ede0] md:to-60%" />
      </div>

      <div className="bg-[#f5ede0] py-20 px-[7vw] md:px-[5vw] flex flex-col justify-center">
        ...
        <h2 className="font-['Cormorant_Garamond',serif] text-[clamp(2rem,4vw,3.2rem)] font-light leading-[1.2] mb-7 text-[#1a2e1b]">
          Искусство{" "}
          <em className="italic text-[#b5633a] not-italic">исцеления</em>,
          <br />
          рождённое на Бали
        </h2>
