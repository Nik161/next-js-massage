export default function Banner() {
  return (
    <section className="relative min-h-120 flex items-center justify-center text-center overflow-hidden">
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1540555700478-4be289fbecef?w=1600&q=80')] bg-cover bg-center brightness-[0.35] saturate-[0.8]" />
